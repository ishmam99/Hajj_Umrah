<template>
    ...
    <!-- Service Section Header -->
        ...
        <router-link to="/learing-center/education-form">
            <div class="bg-white rounded-2xl bg-[url('../assets/image/home/l2.jpg')] w-full bg-top bg-cover bg-origin-contentshadow-2xl  border border-white h-full flex flex-col items-center uppercase text-center relative">
        ...
        <router-link to="/services/social">
            <div class="bg-white rounded-2xl bg-[url('../assets/image/home/l3.jpeg')] w-full bg-top bg-cover bg-origin-contentshadow-2xl  border border-white h-full flex flex-col items-center uppercase text-center relative">
               <div class="h-full rounded-2xl flex flex-col items-center  bg-[#0000007c] w-full px-5 py-12">
            ...
            <router-link to="/services/new_muslim">
               <div class="bg-white rounded-2xl bg-[url('../assets/image/home/l4.jpg')] w-full bg-top bg-cover bg-origin-contentshadow-2xl border border-white h-full flex flex-col items-center uppercase text-center relative">
                  <div class="h-full rounded-2xl flex flex-col items-center  bg-[#0000007c] w-full px-5 py-12">
            ...
            <router-link class="view-all" to="/services/nikah">
               <div class="bg-white rounded-2xl bg-[url('../assets/image/home/l6.jpg')] w-full bg-top bg-cover bg-origin-contentshadow-2xl border border-white h-full flex flex-col items-center uppercase text-center relative">
                  <div class="h-full rounded-2xl flex flex-col items-center  bg-[#0000007c] w-full px-5 py-12">
            ...
            <router-link to="/services/funeral">
               <div class="bg-white rounded-2xl bg-[url('../assets/image/home/l7.jpg')] w-full bg-top bg-cover bg-origin-contentshadow-2xl border border-white h-full flex flex-col items-center uppercase text-center relative">
                  <div class="h-full rounded-2xl flex flex-col items-center  bg-[#0000007c] w-full px-5 py-12">
