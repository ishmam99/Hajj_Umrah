<template>
  <div class="">
    <div class="w-full flex justify-center  bg-repeat-x items-center text-black fixed top-0 z-40 duration-300 bg-white">  
        <div class="flex items-center gap-6  uppercase text-sm w-full font-semibold px-[2%]">
            <div>
