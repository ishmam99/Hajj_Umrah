  ...
  >
    <div class="bg-[#23646da9] p-5 h-full flex flex-col gap-3 font-semibold text-lg">
      ...
      <div class="accordion bg-white p-2 rounded-md">
        <button @click="toggleAccordion('programCreate')" class="flex items-center gap-2 pb-1">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            width="24"
        ...
        <div v-show="currentAccordions === 'programCreate'" class="submenu p-2 flex flex-col gap-1 bg-slate-200 rounded-md">
      ...
      <div class="accordion bg-white p-2 rounded-md">
        <button @click="toggleAccordion('courseManagement')" class="flex items-center gap-2 pb-1">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            width="24"
        ...
        <div v-show="currentAccordions === 'courseManagement'" class="submenu p-2 fkex flex-col gap-1 bg-slate-200 rounded-md">
          ...
          >
          <router-link
            to="/lms_course_management_create_course_module"
      ...
      <div class="accordion bg-white p-2 rounded-md">
        <button @click="toggleAccordion('teacherManagement')" class="flex items-center gap-2 pb-1">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            width="24"
        ...
        <div v-show="currentAccordions === 'teacherManagement'" class="submenu p-2 flex flex-col gap-1 bg-slate-200 rounded-md">
          <router-link
            to="/lms_teacher_management_registered_teachers"
            class="flex items-center gap-1"
            ><svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 24 24"
            ...
            Registered Teachers</router-link
          >
        </div>
      </div>

      <div class="accordion bg-white p-2 rounded-md">
        <button @click="toggleAccordion('studentManagement')" class="flex items-center gap-2 pb-1">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            width="24"
        ...
        <div v-show="currentAccordions === 'studentManagement'" class="submenu p-2 flex flex-col gap-1 bg-slate-200 rounded-md">
