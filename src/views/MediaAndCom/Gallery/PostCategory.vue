<template>
  <div class="px-5  py-5 w-3/4">
          <p class="text-2xl text-yellow-600 font-bold py-3 border-b">Post Category</p>
          <hr />
          <div class="bg-white rounded-xl p-5 w-full shadow-md mt-5">
            <form @submit.prevent="CategoryPostSubmit()">
              <div class="py-5 space-y-7 mt-5">
                <div class="flex items-center justify-center gap-5">
                  <div class="relative mb-3 w-full">
                    <input
                      ...
                      value=""
                      v-model="categoryPostForm.title"
                    />
                    <label
                ...
                <div class="relative">
                  ...
                  <textarea
                    ...
                    v-model="categoryPostForm.description"
                  ></textarea>
                </div>
...
const selectedFile = ref(null)
  ...
  categoryPostForm.value.image = event.target.files[0]
...
const CategoryPostSubmit = async () => {
  loading.value = true
  try {
    const data = await api().post('post-category-store',categoryPostForm.value, {
      headers: {
