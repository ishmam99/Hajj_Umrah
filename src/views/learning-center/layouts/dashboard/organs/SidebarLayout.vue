...
<template>
  <div class="sidebar">
    ...
    <div class="menus">
      <router-link to="/dashboard" :class="$route.path === '/dashboard' ? 'item active' : 'item'">
      ...
      <router-link
        v-if="user.role_id == 7"
        to="/dashboard/student-group-course"
      ...
      <router-link
        v-if="user.role_id == 6 || user.role_id == 7"
      ...
      <router-link
        v-if="user.role_id == 2"
        to="/advisor/dashboard/enrollment"
      ...
      <router-link
        v-if="user.role_id == 2"
        to="/advisor/dashboard/group-list"
