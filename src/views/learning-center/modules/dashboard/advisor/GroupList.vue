  ...
  <div class="dashboard-content">
    ...
    <div class="dashboard-wrapper">
      ...
      >
        ...
        <Column field="teacher" header="Batch Name" style="min-width: 10rem">
          <template #body="slotProps">
            {{
        ...
        <Column field="student" header="Starting Date" style="min-width: 10rem">
          <template #body="slotProps">
            {{
        ...
        <Column header="Action" :exportable="false" style="min-width: 8rem">
          <template #body="slotProps">
            ...
            >
              <span
                class="shadow-md ml-4 text-blue-500 text-lg hover:shadow-lg"
              >
