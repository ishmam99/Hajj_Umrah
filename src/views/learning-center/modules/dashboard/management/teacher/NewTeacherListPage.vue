...
async function getData() {
  const resp = await axios.get(import.meta.env.VITE_ELEARNING_BASE_API + 'get-new-teacher')
...
<template>
  <div class="dashboard-content">
    <img src="@/assets/images/dashboard/teacher-management/new-teacher.png" alt="" />
        ...
        <template #header>
          <div class="display-center">
            <div class="dashboard-title">
              <font-awesome-icon :icon="['fas', 'fa-money-check']" /> New Teacher List
            </div>
