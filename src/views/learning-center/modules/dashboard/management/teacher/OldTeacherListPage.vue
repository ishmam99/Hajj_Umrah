...
async function getData() {
  const resp = await axios.get(
    import.meta.env.VITE_ELEARNING_BASE_API + 'get-ex-teacher'
  )
...
<template>
  <div class="dashboard-content">
    <img
      src="@/assets/images/dashboard/teacher-management/old-teacher.png"
      alt=""
    />
        ...
        <template #header>
          <div class="display-center">
            <div class="dashboard-title">
              <font-awesome-icon :icon="['fas', 'fa-money-check']" /> Old
              Teacher List
            </div>
