...
import VolunteerSidebar from '@/views/GetInvolved/Volunteers/VolunteerSideBar.vue'
import {
  Select,
  SelectContent,
  SelectGroup,
              ...
              <div class="py-5 space-y-7 mt-5">
                ...
                <div class="relative">
                  ...
                  <input
                    ...
                    cols=""
                    rows="4"
                    placeholder="Need any qualification for applying as volunteer?"
                    class="w-full p-3 pt-5 rounded-lg border-2 focus:outline-gray-200"
                  />
                </div>
                ...
                <div class="relative">
                  ...
                  <input
                    ...
                    cols=""
                    rows="4"
                    placeholder="Set the volunteer location"
                    class="w-full p-3 pt-5 rounded-lg border-2 focus:outline-gray-200"
                  />
                </div>
