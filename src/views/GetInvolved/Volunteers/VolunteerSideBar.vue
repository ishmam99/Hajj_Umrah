...
<template>
  ...
  >
    <div class="bg-[#e1f2ff9a] p-5 h-full flex flex-col gap-3 font-semibold text-lg">
      ...
      <router-link to="/volunteer/volunteer-dashboard" class="flex items-center gap-2"
        ><svg
      ...
      <router-link to="/volunteer/create-volunteer-job" class="flex items-center gap-2">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          width="24"
      ...
      <router-link to="/volunteer/apply-volunteer-job" class="flex items-center gap-2">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          width="24"
