<template>
  <div>
    <DefaultLayout>
      <div
        class="px-20 pt-20 mt-5 py-5 bg-blue-800 bg-[url('/src/assets/image/home/bg123.png')] bg-repeat shadow-xl"
      >
      ...
      <div
        class="w-full h-screen flex justify-center items-center bg-[url('/src/assets/image/common/bg-fund.jpg')] bg-cover"
      >
          ...
          <form @submit.prevent="login(user)">
            <div class="max-h-[750px] w-[600px] bg-[#ffffff] p-5 rounded-lg shadow-md">
              ...
              <input
                ...
                v-model="data.email"
                type="email"
                class="border border-gray-300 focus:outline-blue-600 rounded-md w-full py-1.5 px-3"
              />
              ...
              <button
                type="submit"
                class="bg-blue-600 w-full px-3 py-2 rounded-md my-3 text-white font-semibold"
              >
                Login
              </button>
              ...
              <div class="flex text-sm justify-between gap-2">
                ...
                <router-link
                  to="/Signup"
                  class="text-gray-500 font-semibold hover:text-blue-600 cursor-pointer"
