      ...
      <div class="px-20 pt-20 mt-5 py-5 bg-cyan-800 bg-[url('../assets/image/home/bg123.png')] bg-repeat shadow-xl">
        <div class="pt-3 mx-36 pb rounded-xl bg-[#ffffff] border-blue-50 shadow-xl border-[3px]">
          <div class="flex items-center justify-center gap-2 font-semibold">
            ...
            <p>/ Get Involved</p>
            <!-- <p>/ Volunteers</p> -->
            <p class="text-cyan-800">/ Apply For Guest Imam</p>
          </div>
          <div class="rounded-lg flex items-center justify-center relative py-3">
            <h1 class="text-cyan-800 text-4xl font-bold"> Apply For Guest Imam</h1>
            <div>
              <p></p>
            </div>
          </div>
      ...
      <div class="bg-[#1a504785] h-full py-5 pt-10 flex items-center justify-center gap-5 px-20 w-full">
        <div class="space-y-8 w-3/4">
          <div class="bg-white rounded-xl p-5 w-full">
            ...
            <div class="pt-5">
              <h1 class="text-2xl font-bold">Guest Imam Application</h1>
            </div>
            <div class="py-5 space-y-7 mt-5">
              ...
              <div class="flex items-center gap-5">
                <div class="relative mb-3 w-full">
                  <div class="gap-5">
                    <label for="">Preferred Date <span class="text-red-500">*</span> </label>
                    <div class="pt-2">
                      <input
                        type="date"
                ...
                <!-- <div class="relative mb-3 w-full">
                  <div class="gap-5">
                    <label for="">Preferred Time <span class="text-red-500">*</span> </label>
                    <div class="pt-2">
                      <input
                        type="time"
                        class="py-2 px-6 rounded-2xl w-full border-2 border-grau-400"
              ...
              <div>
                <p for="" class="mb-3">Preferred Prayer <span class="text-red-500">*</span> </p>
                <Select>
                  ...
                  <SelectContent>
                    <SelectGroup>
                      <SelectLabel>Prayer</SelectLabel>
              ...
              <button class="w-[350px] h-[45px] rounded-2xl bg-cyan-800 text-white font-bold mx-auto flex items-center text-center justify-center">
                Apply
              </button>
            </div>
          </div>
