      ...
      <div class="px-20 ml-10">
        <div class="bg-white">
          <div class="flex items-center gap-2">
            ...
            <p>Home</p>
            <p>/ Services</p>
            <p class="text-yellow-500">/ Nikah Services</p>
          </div>
          <div class="bg-white rounded-lg relative py-3">
            <h1 class="text-yellow-500 text-4xl font-semibold">Nikah Services</h1>
            <div>
              <p></p>
            </div>
          </div>
        ...
        <div>
          ...
          <div class="bg-white rounded-xl p-5 w-[450px]">
            <div class="flex items-center">
              ...
              <h1 class="text-xl py-3">Facilities Services</h1>
            </div>
            <hr />
            <div class="flex items-center">
              <svg
              ...
              <h1 class="text-xl py-3">Matrimony Services</h1>
            </div>
            <hr />
            <div class="flex items-center">
              <svg
              ...
              <h1 class="text-xl py-3">Special Need Services</h1>
            </div>
            <hr />
            <div class="flex items-center">
              <svg
              ...
              <h1 class="text-xl py-3">New Muslim Services</h1>
            </div>
            <hr />
            <div class="flex items-center">
              <svg
              ...
              <h1 class="text-xl py-3">Funeral Services</h1>
            </div>
            <hr />
            <div class="flex items-center">
              <svg
            ...
            <div class="flex items-center">
              ...
              <h1 class="text-xl py-3">Education Services</h1>
            </div>
            <hr />
            <div class="flex items-center">
              <svg
