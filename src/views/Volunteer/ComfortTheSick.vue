      ...
      <div class="px-20 pt-20 mt-5 py-5 bg-cyan-800 bg-[url('/src/assets/image/home/bg123.png')] bg-repeat shadow-xl">
        <div class="pt-3 mx-36 pb rounded-xl bg-[#ffffff] border-blue-50 shadow-xl border-[3px]">
          <div class="flex items-center justify-center gap-2 font-semibold">
            ...
            <p>/ Get Involved</p>
            <p>/ Volunteers</p>
            <p class="text-cyan-800">/ Volunteer Services</p>
          </div>
          <div class="rounded-lg flex items-center justify-center relative py-3">
            <h1 class="text-cyan-800 text-4xl font-bold"> Comfort The Sick</h1>
            <div>
              <p></p>
            </div>
          </div>
      ...
      <div class="bg-gray-100 h-full py-5 flex gap-5 px-20 w-full">
        <div class="space-y-8 w-3/4">
          <div class="bg-white rounded-xl p-5 w-full">
            <p>
              IDL volunteering integrates environmental and community development practices in the
              way we live. The mission is to establish and maintain a program that identifies and
              provides opportunities for IDL community members where we can make positive and
              consistent contributions to our society with our personal time & presence. We believe
              that community members have better cohesion and are more invested in the community if
          ...
          <div class="bg-white rounded-xl p-5 w-full">
            ...
            <ul class="pl-10">
              ...
              <li class="list-disc">
                ...
                and once we engage with sick individuals.
              </li>
            </ul>
          </div>
          <div class="bg-white rounded-xl p-5 w-full">
