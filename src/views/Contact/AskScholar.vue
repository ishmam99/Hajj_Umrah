        ...
        <div class="px-20 pt-20 mt-5 py-5 bg-teal-800 bg-[url('/src/assets/image/home/bg123.png')] bg-repeat shadow-xl">
          <div class="pt-3 mx-36 pb rounded-xl bg-[#ffffff] border-blue-50 shadow-xl border-[3px]">
            <div class="flex items-center justify-center gap-2 font-semibold">
              ...
              <p>/ Contact</p>
              <!-- <p>/ Volunteers</p> -->
              <p class="text-teal-800">/ Ask Scholar</p>
            </div>
            <div class="rounded-lg flex items-center justify-center relative py-3">
              <h1 class="text-teal-800 text-4xl font-bold"> Ask Scholar</h1>
              <div>
                <p></p>
              </div>
            </div>
          ...
          <div class="space-y-8 w-3/4">
            <div class="bg-white px-8 py-5 pt-5 gap-5 rounded-lg">
              ...
              <p class="mt-5">
                ...
                CONFIDENTIAL BETWEEN YOU AND YOUR PREFERRED SCHOLAR
              </p>
              ...
              <div class="py-5 space-y-7 mt-5">
                ...
                <div>
                    <p for="" class="mb-3">Preferred Scholar <span class="text-red-500">*</span> </p>
                    <Select>
                      <SelectTrigger class="w-full">
                        <SelectValue placeholder="Select one scholar" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectGroup>
                          <SelectLabel>Scholar</SelectLabel>
                          <SelectItem value="apple"> Dr. Yasir Qadhi</SelectItem>
                          <SelectItem value="shelter"> Dr. Waleed Al-Maneese </SelectItem>
                          <SelectItem value="banana"> Imam Nadim Bashir </SelectItem>
                          <SelectItem value="blueberry"> Ustadh Mohamad Baajour </SelectItem>
                          <SelectItem value="grapes"> Sheikh Sajjad Gul </SelectItem>
                        </SelectGroup>
                      </SelectContent>
                    </Select>
                  </div>
              ...
              <div class="bg-white px-0 py-5 pt-2 gap-5 rounded-lg">
                ...
                <div class="flex justify-center pt-5 pb-3">
                  <button
                    class="w-full h-[45px] rounded-2xl bg-teal-800 text-white font-bold mx-auto"
                  >
                    Submit
                  </button>
                </div>
