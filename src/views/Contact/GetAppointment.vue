<template>
    <div>
      <DefaultLayout>
        <div class="px-20 pt-20 mt-5 py-5 bg-blue-900 bg-[url('/src/assets/image/home/bg123.png')] bg-repeat shadow-xl">
          ...
          <div class="space-y-8 w-3/4">
            <div class="bg-white px-8 py-5 pt-5 gap-5 rounded-lg">
              ...
              <div class="py-5 space-y-7 mt-5">
                ...
                <div>
                    <p for="" class="mb-3">Appointment From <span class="text-red-500">*</span> </p>
                    <Select>
                      <SelectTrigger class="w-full">
                        <SelectValue placeholder="Appointment From" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectGroup>
                          <SelectLabel>Appointment From</SelectLabel>
                          <SelectItem value="apple"> Scholar</SelectItem>
                          <SelectItem value="shelter"> Imam </SelectItem>
                          <SelectItem value="banana"> Board Of Director </SelectItem>
