<template>
  ...
  >
    <div class="bg-[#135D66] p-5 h-full flex flex-col gap-3 font-semibold text-lg">
      <p class="text-xl font-bold text-white">Vendor Management Dashboard</p>
      <p class="text-xl font-bold text-white">Welcome Mr. Hashim</p>
      <router-link
        to="/Vendor_management_dashboard_Profile"
      ...
      >
      <router-link
        to="/Vendor_management_Dashboard/Profile"
        class="flex items-center gap-2 bg-white p-2 rounded-md"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
      ...
      <div class="accordion bg-white rounded-md">
        <router-link
        to="/vendor_management_vendor_list"
        class="flex items-center gap-2 bg-white p-2 rounded-md"
        >
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M3.75 12h16.5m-16.5 3.75h16.5M3.75 19.5h16.5M5.625 4.5h12.75a1.875 1.875 0 0 1 0 3.75H5.625a1.875 1.875 0 0 1 0-3.75Z" />
          ...
          Vendor List</router-link
      >
      </div>

      <div class="accordion bg-white rounded-md">
        <router-link
        to="/vendor_management_vendor_package_list"
        class="flex items-center gap-2 bg-white p-2 rounded-md"
        >
        <svg
            xmlns="http://www.w3.org/2000/svg"
          ...
          Vendor Package List</router-link
      >
      </div>
