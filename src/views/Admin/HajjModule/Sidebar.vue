...
<template>
  <div class="bg-[url('/src/assets/image/common/bg-pattern.jpg')] bg-cover w-1/4 min-h-screen sticky top-[80px]">
    <div class="bg-[#e1f2ff9a] p-5 h-full flex flex-col gap-3 font-semibold text-lg">
      <p class="text-2xl font-bold text-[#2e318a]">Hajj Package Management System</p>
      ...
      <div class="accordion">
        ...
        <div v-if="currentAccordions === 'projectManagement'" class="submenu mx-8">
          <router-link to="/Hajj_package_create_new_package" class="flex items-center gap-2 hover:px-2">- Create New Package</router-link>
          <router-link to="/Hajj_package_current_packages" class="flex items-center gap-2 hover:px-2">- Current
            Packages</router-link>
          <router-link to="/Hajj_package_previous_packages" class="flex items-center gap-2 hover:px-2">- Previous
            Packages</router-link>
