<template>
  <div class="bg-white border-x-2 border-teal-700 border-b-2 px-2">
        ...
        <form class="space-y-4" @submit.prevent="saveFlightData()">
          ...
          <div class="flex w-full gap-4">
            ...
            <div class="flex flex-col items-center space-y-2 justify-start w-1/2">
              ...
              <input type="date" v-model="departureDate" id="departure_date"
            ...
            <div class="w-full bg-gray-100 p-2 rounded-md shadow-md" v-else>
              ...
              <div v-for="flight in filteredRoutes" :key="flight.id">
                <div class="flex justify-between items-center px-2 rounded-lg bg-white">
                  ...
                  <div class="flex gap-1  px-4 py-2 w-[300px] justify-between items-center">
      ...
      <div class="border-t-2 border-teal-600 p-5">
        <div class="flex justify-start gap-5 items-center w-full py-2 px-5" v-if="packageDetails">
          ...
          <button @click="updatePackageStatus" class="btn btn-info text-white" :disabled="applying">
            <svg xmlns="http://www.w3.org/2000/svg" v-if="applying" class="animate-spin" viewBox="0 0 24 24" width="18"
