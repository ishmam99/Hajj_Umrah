      ...
      <div class="px-20 ml-10">
        <div class="bg-white">
          <div class="flex items-center gap-2">
            ...
            <p class="text-yellow-500">About Us</p>
          </div>
          <div class="bg-white rounded-lg relative py-3">
            <h1 class="text-yellow-500 text-4xl font-semibold">About Us</h1>
            <div>
              <p></p>
            </div>
          </div>
        ...
        <div class="space-y-8 w-1/2">
          <Card class="rounded-2xl">
            ...
            <CardContent class="text-gray-600">
              IDL is a non-profit tax-exempt organization (with Tax-ID: 20-0629612) that has been
              formed exclusively for educational, religious, and social purposes. It is registered
              with the Internal Revenue Service under revenue code 501(c)(3). All of its activities
              are in accordance with the teachings of the Quran and following the teachings and
              traditions of Prophet Mohammed (Peace Be upon Him). EPIC is a multi-ethnic,
              multi-racial, multi-lingual, non-sectarian, diverse, and open community committed to
              full and equal participation and involvement of men and women who are community
              members of EPIC and subscribe to accept its rules, regulations, and procedures. EPIC
              is committed to civic and civil engagement with communities of other faiths and
              society at large.
              IDL is a non-profit tax-exempt organization (with Tax-ID: 20-0629612) that has been formed exclusively for educational, religious, and social purposes. It is registered with the Internal Revenue Service under revenue code 501(c)(3). All of its activities are in accordance with the teachings of the Quran and following the teachings and traditions of Prophet Mohammed (Peace Be upon Him). EPIC is a multi-ethnic, multi-racial, multi-lingual, non-sectarian, diverse, and open community committed to full and equal participation and involvement of men and women who are community members of EPIC and subscribe to accept its rules, regulations, and procedures. EPIC is committed to civic and civil engagement with communities of other faiths and society at large.
            </CardContent>
          </Card>
          <Card class="rounded-2xl">
            <CardHeader>
