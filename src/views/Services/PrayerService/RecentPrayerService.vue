<template>
    <div>
      <DefaultLayout>
        <div class="px-20 pt-20 mt-5 py-5 bg-green-800 bg-[url('../assets/image/home/bg123.png')] bg-repeat shadow-xl">
          <div class="pt-3 mx-36 pb rounded-xl bg-[#ffffff] border-blue-50 shadow-xl border-[3px]">
            <div class="flex items-center justify-center gap-2 font-semibold">
              ...
              <p>/ Services</p>
              <p>/ Prayer Service</p>
              <p class="text-green-800">/ Recent Prayer Service</p>
            </div>
            <div class="rounded-lg flex items-center justify-center relative py-3">
              <h1 class="text-green-800 text-4xl font-bold"> Recent Prayer Service </h1>
              <div>
                <p></p>
              </div>
            </div>
