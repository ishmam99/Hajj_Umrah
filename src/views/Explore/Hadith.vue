<template>
  <div>
    <DefaultLayout>
    <div class="px-20 pt-20 py-5 bg-cyan-800 bg-[url('../assets/image/home/bg123.png')] bg-repeat shadow-xl">
        <div class="pt-3 mx-36 pb rounded-xl bg-[#308386ac]  border-[#18272b5a] shadow-xl border-[3px]">
          <div class="flex items-center justify-center gap-2">
            ...
            <p class="text-white">/ Digital Library</p>
            <!-- <p>/ Volunteers</p> -->
            <p class="text-[#c0ece4]">/ Hadith</p>
          </div>
          <div class="rounded-lg flex items-center justify-center relative py-3">
            <h1 class="text-white text-4xl font-semibold">Hadith</h1>
            <div>
              <p></p>
            </div>
          </div>
