        ...
        <table class="table w-full border-collapse border border-gray-300">
          ...
          <thead>
            <tr class="bg-gray-800 text-white items-center text-xl">
              ...
              <th>Started Date - Ended Date</th>
            </tr>
          </thead>
          <tbody>
            <!-- row 1 -->
            <tr v-for="(pkg, index) in packages" v-if="packages.length > 0" :key="index" class="bg-gray-100">
              <!-- <td>{{ index + 1 }}</td> -->
              <td>
              ...
              <td class="text-center">
                <span class="font-medium flex justify-center items-center gap-2 text-gray-700">
