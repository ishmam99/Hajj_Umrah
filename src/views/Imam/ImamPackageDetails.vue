<template>
  ...
  <div class="px-5  bg-slate-50 py-5 w-4/5 mx-auto">
    <Breadcrumb />
    ...
    <div v-if="currentTab === 'details'" class="bg-green-100 py-10">
      ...
      <div v-if="packageDetails" class="px-6 py-10 max-w-7xl mx-auto bg-white shadow-2xl rounded-2xl ">
        <div class="flex items-center bg-sky-600 py-6 justify-between px-4 rounded text-xl text-white font-semibold">
          ...
          <p class="border-s-2 px-1 text-center w-full">Origin Country: <span class="">{{ packageDetails.country.name }}</span></p>
          <p class="border-s-2 px-1 text-center w-full">Origin City: <span class="">{{ packageDetails.city.name }}</span></p>  
          <p class="border-s-2 px-1 text-center w-full">Origin Airport: <span class="">{{ packageDetails.airport.name }}</span></p>  
        </div>
