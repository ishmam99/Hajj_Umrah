<template>
  <div class="flex flex-col min-h-screen justify-center w-full p-6 container">
    <Breadcrumb class="border-b-2"/>
    <div class="min-h-screen flex justify-center w-full items-center p-6 ">
