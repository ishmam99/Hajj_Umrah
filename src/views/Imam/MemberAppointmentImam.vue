<template>
    <div class="px-5 bg-white py-5 w-3/4">
                  <p class="text-2xl font-bold py-3 border-b">Imam Appointment List</p>
                    <div class="grid grid-cols-1 gap-5 mt-5">
                        ...
                        class="flex justify-between bg-slate-100 p-5 rounded-md shadow-md">
                            <div class="flex gap-5">
                                <div>
                                    <p class="text-lg font-bold">Preferrd Imam : <span class="font-[500]">{{item.imam_name}}</span></p>
                                    <p class="text-lg font-bold">Applied Date : <span class="font-[500]">{{ item.created_at }}</span></p>
                                </div>
                            </div>
