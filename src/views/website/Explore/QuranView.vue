  ...
  <DefaultLayout>
      ...
      <div class="bg-white">
        <div class="flex items-center gap-2">
          ...
          <p>
            ...
            /Explore /
            <router-link to="/explore/quran">Quran</router-link>/
          </p>
    ...
    <div class="p-20 bg-gray-100 gap-5">
      <Card class="rounded-2xl border-sky-200" v-if="surah">
        <CardHeader>
          <CardTitle class="text-3xl text-slate-700 text-center"
            >{{ surah.englishName }} <span class="text-xl">({{ surah.name }})</span></CardTitle
          >
          <h1 class="font-semibold text-xl text-center text-amber-600">
        ...
        <CardContent class="text-gray-600">
          ...
          <div class="flex-wrap justify-end py-5">
            ...
            <p v-for="ayah in surah.ayahs" class="text-center">{{ ayah.text }}</p>
          </div>
        </CardContent>
      </Card>
    </div>
