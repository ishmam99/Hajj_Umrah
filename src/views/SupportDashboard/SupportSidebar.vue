<template>
    <div class="bg-[#3AA6B9] bg-cover w-2/12">
      <div class="p-5 flex flex-col gap-3 font-semibold text-lg h-full">
        <p class="text-2xl font-bold text-[#ffffff]">Support Dashboard &nbsp; &nbsp;</p>
        <p class="text-white mb-5">Welcome <span class="text-lg font-bold text-yellow-300">Mr. Mushfiq Rahman</span></p>
        <router-link to="/support_profile" @click="dropdown = 0"
      ...
      <div class="bg-white p-2 rounded-md cursor-pointer ">
        ...
        <div v-if="dropdown == 2" class="flex flex-col gap-3 pl-2 py-2 bg-slate-100 rounded-md">
          <router-link to="/support_packages_active_package" class="flex items-center gap-2 cursor-pointer">
          ...
          <router-link to="support_packages_upcoming_package" class="flex items-center gap-2 cursor-pointer">
          ...
          <router-link to="support_packages_completed_package" class="flex items-center gap-2 cursor-pointer">
      ...
      <div class="bg-white p-2 rounded-md cursor-pointer ">
        ...
        <div v-if="dropdown == 3" class="flex flex-col gap-3 pl-2 py-2 bg-slate-100 rounded-md">
          <router-link to="/support_packages_pending_payments" class="flex items-center gap-2 cursor-pointer">
          ...
          <router-link to="/support_packages_received_payments" class="flex items-center gap-2 cursor-pointer">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="currentColor">
              <path
