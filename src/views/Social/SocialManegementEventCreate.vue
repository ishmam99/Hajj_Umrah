              ...
              <div class="relative mb-3">
                <div class="">
                  ...
                  <div class="flex gap-2 items-center">
                    <div>
                      <input type="radio" name="" id="" value="single" v-model="occurrence.type" />
                    ...
                    <div>
                      ...
                      <Dialog>
                        ...
                        <DialogContent class="h-3/5">
                          <DialogHeader>
                            <DialogTitle>
                              <div class="font-bold text-2xl mb-6 text-center">Recurrence Form</div>
                            </DialogTitle>
                            <DialogDescription>
                              ...
                              <div class="mt-2 flex items-center font-semibold gap-2 text-black">
                                <p>Repeat Every</p>
                                <Input
                                  type="number"
                                  placeholder="number"
                              ...
                              <div class="flex items-center gap-2 mt-2 text-black font-semibold">
                                <div>
                              ...
                              <div>
                                <h1 class="text-xl font-semibold text-black mt-4 mb-2">Ends</h1>
          ...
          <div class="flex gap-5">
            <div class="relative w-1/2">
              ...
              <textarea
                ...
                placeholder="Ex:23"
                class="w-full p-3 pt-5 rounded-lg border-2 focus:outline-gray-200"
                v-model="EventForm.human_resource"
              ></textarea>
            </div>
            <div class="relative w-1/2">
              <p class="p-3 absolute top-[-25px] left-2 bg-white text-gray-600">
              ...
              <textarea
                ...
                placeholder="Ex:23"
                class="w-full p-3 pt-5 rounded-lg border-2 focus:outline-gray-200"
                v-model="EventForm.material_resource"
              ></textarea>
            </div>
          </div>
