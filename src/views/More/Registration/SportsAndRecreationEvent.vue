      ...
      <div class="px-20 ml-10">
        <div class="bg-white">
          <div class="flex items-center gap-2">
            ...
            <p>/ More</p>
            <p>/ Registration</p>
            <p class="text-yellow-500">/ Sports &amp; Recreation Event </p>
          </div>
          <div class="bg-white rounded-lg relative py-3">
            <h1 class="text-yellow-500 text-4xl font-semibold">Sports &amp; Recreation Event</h1>
            <div>
              <p></p>
            </div>
          </div>
      ...
      <div class="bg-gray-100 h-full py-5 mt-10 flex gap-5 px-20 w-full">
        <div class="space-y-8 w-3/4">
          <div class="bg-white rounded-xl p-5 w-full">
            <h1 class="text-3xl font-semibold">Sports &amp; Recreation Event</h1>
            <p class="pt-5">
              IDL-Sports &amp; Recreation event is for community members living in Zip Codes: 75074, 75075,
              75080, 75081, 75082, 75044, 75002, 75094, 75048, 75044, 75098.
            </p>
            <p class="pt-5 font-semibold">There are two types of Memberships avaialble:</p>
