      ...
      <div class="px-20 ml-10">
        <div class="bg-white">
          <div class="flex items-center gap-2">
            ...
            <p>/ More</p>
            <p>/ Registration</p>
            <p class="text-yellow-500">/ ESL Class Registration</p>
          </div>
          <div class="bg-white rounded-lg relative py-3">
            <h1 class="text-yellow-500 text-4xl font-semibold">ESL Class Registration</h1>
            <div>
              <p></p>
            </div>
          </div>
      ...
      <div class="bg-gray-100 h-full py-5 mt-10 flex gap-5 px-20 w-full">
        <div class="space-y-8 w-3/4">
          <div class="bg-white rounded-xl p-5 w-full">
            <h1 class="text-3xl font-semibold">ESL Class Registration</h1>
            <p class="pt-5">
              IDL-ESL class registration is for community members living in Zip Codes: 75074, 75075,
