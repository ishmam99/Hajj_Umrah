<template>
    <div class="px-5 bg-slate-50 py-5 w-3/4">
        <p class="text-2xl text-cyan-700 font-bold pb-2">Create Prayer Announcement</p>
                ...
                <div class="py-5 space-y-7 mt-5">
                    <div class="flex justify-between gap-5">
                        <div class="w-1/2 flex flex-col gap-5">
                            <div class="relative">
                                <div class="gap-5">
                                    ...
                                    <div class="pt-2">
                                        <input type="text" class="py-2 px-6 rounded-2xl w-full border-2"
                        ...
                        <div class="w-1/2 flex flex-col gap-5">
                            <div class="relative">
                                <div class="gap-5">
                                    <label for="" class=""> Waqt <span class="text-red-500">*</span> </label>
                                    <div class="pt-2">
                                        <input type="text" class="py-2 px-6 rounded-2xl w-full border-2"/>
                                    </div>
                                </div>
                    ...
                    <div class="flex justify-between gap-5">
                        <div class="w-1/3 flex flex-col gap-5">
                            <div class="relative">
                                <div class="gap-5">
                                    <label for="" class="">Starting Date <span class="text-red-500">*</span> </label>
                                    <div class="pt-2">
                                        <input type="date" class="py-2 px-6 rounded-2xl w-full border-2" />
                                    </div>
                                </div>
                            </div>
                            <div class="relative">
                                <div class="gap-5">
                                    <label for="">Adhaan <span class="text-red-500">*</span> </label>
                                    <div class="pt-2">
                        ...
                        <div class="w-1/3 flex flex-col gap-5">
                            ...
                            <div class="relative">
                                <div class="gap-5">
                                    <label for="">Jamat <span class="text-red-500">*</span> </label>
                                    <div class="pt-2">
                                        <input type="time" class="py-2 px-6 rounded-2xl w-full border-2" />
                                    </div>
                                </div>
                        ...
                        <div class="w-1/3 flex flex-col gap-5">
                            <div class="">
                                <label for="" class="text-gray-600">Event Thumbnail <span
