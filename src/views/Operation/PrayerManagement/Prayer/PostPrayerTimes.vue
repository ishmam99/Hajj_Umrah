    ...
    <div class="grid grid-cols-3 gap-5 p-5 rounded-2xl drop-shadow-md mt-3">
      <div class="bg-white rounded-2xl drop-shadow-md p-5">
        ...
        <div class="flex justify-between gap-5 py-3 px-5">
          <button class="py-1.5 px-3 rounded-md shadow-md bg-green-600 text-white text-xs">
            Post
          </button>
          <button class="py-1.5 px-3 rounded-md shadow-md bg-yellow-600 text-white text-xs">
            Edit
          </button>
          <button class="py-1.5 px-3 rounded-md shadow-md bg-red-600 text-white text-xs">
            Delete
          </button>
        </div>
      </div>
