<template>
  <div class="px-4 bg-white py-5 w-3/4">
    <p class="font-semibold">Prayer Management > Khatira > BroadCast Khutbah Scedule</p>
    <div class="flex justify-between items-center pt-4">
      <p class="text-2xl text-yellow-600 font-bold pb-2">BroadCast Khutbah Scedule</p>
    </div>
    <hr />
    <div
    ...
    <div class="flex justify-between items-center pt-8">
      <p class="text-2xl text-yellow-600 font-bold pb-2">Edit: {{ `Save The Children` }} </p>
    </div>
    <hr />
