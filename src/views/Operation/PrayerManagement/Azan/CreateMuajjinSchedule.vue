        ...
        <tbody>
          <tr class="">
            ...
            <td class="py-4 p-2 flex items-center gap-2">
              <h3 class="font-bold">Abdullah</h3>
            </td>
            <td>
              <p class="text-lg">Fajr</p>
            </td>
