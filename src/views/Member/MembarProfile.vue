<template>
   <div class="px-[5%] bg-white py-5 rounded-md shadow-md w-3/4">
        <p  class="text-2xl text-yellow-600 text-center font-bold">Your Profile</p>
        <img src="/src/assets/image/home/h1.png" alt="" class="h-[100px] w-[100px] rounded-full border shadow-md">
        <p class="text-sm text-gray-500 pt-5">Name</p>
        <p class="text-xl font-semibold pb-2 border-b">Azim</p>
        <p class="text-sm text-gray-500 pt-5">Email Address</p>
        <p class="text-xl font-semibold pb-2 border-b">abc@gmail.com</p>
        <p class="text-sm text-gray-500 pt-5">Phone Number</p>
        <p class="text-xl font-semibold pb-2 border-b">+8801722222222</p>
        <p class="text-sm text-gray-500 pt-5">Gender</p>
        <p class="text-xl font-semibold pb-2 border-b">Male</p>
        <p class="text-sm text-gray-500 pt-5">Date of Birth (DD/MM/YY)</p>
        <p class="text-xl font-semibold pb-2 border-b">1/1/22</p>
        <div class="bg-slate-50 shadow-md rounded-md p-2 mt-5 ">
            ...
            <div class="mt-5 p-2 bg-green-100 border border-green-500 rounded-md flex justify-between items-center gap-2">
            ...
            <div class="mt-5 p-2 pl-10 bg-gray-100 border border-gray-500 rounded-md flex justify-between items-center gap-2">
                <div class="flex items-center gap-2">
                    <div>
