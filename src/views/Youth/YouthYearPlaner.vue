          ...
          <table class="table-auto w-full">
            ...
            <tbody>
              <tr class="">
                ...
                <td class="py-4 px-2 text-center text-sm w-1/4"><input type="date" class="w-full p-2"></td>
                <td class="py-4 px-2 text-center text-sm w-1/4"><input type="time" class="w-full p-2"></td>
