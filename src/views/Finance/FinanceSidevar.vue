<template>
  ...
  >
    <div class="bg-[#e1f2ff9a] p-5 h-full flex flex-col gap-3 font-semibold text-lg">
      ...
      <router-link to="/Finance_Dashboard" class="flex items-center gap-2"
        ><svg
      ...
      <router-link to="/Finance_Accounts" class="flex items-center gap-2"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          width="24"
      ...
      <router-link to="/Finance_Operational_Expenses" class="flex items-center gap-2"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          width="24"
      ...
      <router-link to="/Finance_Project_Expenses" class="flex items-center gap-2"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          width="24"
        ...
        >
          <path
            d="M9 1V3H15V1H17V3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H7V1H9ZM20 11H4V19H20V11ZM11 13V17H6V13H11ZM7 5H4V9H20V5H17V7H15V5H9V7H7V5Z"
          ></path></svg
        >Projects Expenses</router-link
      >

      <router-link to="/Finance_Deposits" class="flex items-center gap-2"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          width="24"
      ...
      <router-link to="/Finance_Donations" class="flex items-center gap-2"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          width="24"
