  ...
  >
    <div class="bg-[#e1f2ff9a] p-5 h-full flex flex-col gap-3 font-semibold">
      ...
      <div>
        ...
        <ul class="pl-8 flex flex-col gap-1 overflow-hidden" :class="drop == 1 ? 'h-fit' : 'h-0'">
          <li>
            <ul class="flex items-center gap-2">
              <router-link
                to="/Finance_Dashboard/Account_Ledger_List"
                class="flex items-center gap-2 group duration-150"
                ><p
                  class="h-[2px] w-3 bg-black group-hover:w-5 group-hover:bg-[#2e318a] duration-150"
                ></p>
                Ledger Management</router-link
              >
            </ul>
          </li>
          <li>
            <ul class="flex items-center gap-2">
              <router-link
                to="/Finance_Dashboard/Payroll_Create"
                class="flex items-center gap-2 group duration-150"
                ><p
                  class="h-[2px] w-3 bg-black group-hover:w-5 group-hover:bg-[#2e318a] duration-150"
                ></p>
                Payroll Management</router-link
              >
            </ul>
          </li>
          <li>
            ...
            <ul class="pl-5 flex flex-col gap-1">
              <router-link
                to="/Finance_Dashboard/Operation_Expense"
                class="flex items-center gap-2 group duration-150"
                ><p
                  class="h-[2px] w-3 bg-black group-hover:w-5 group-hover:bg-[#2e318a] duration-150"
                ></p>
                Operational expenses</router-link
              >
              <router-link
                to="/Finance_Dashboard/Project_Expense"
                class="flex items-center gap-2 group duration-150"
                ><p
                  class="h-[2px] w-3 bg-black group-hover:w-5 group-hover:bg-[#2e318a] duration-150"
                ></p>
                Project expenses</router-link
              >
            </ul>
          </li>
        </ul>
      ...
      <div>
        ...
        <ul class="pl-8 flex flex-col gap-1 overflow-hidden" :class="drop == 2 ? 'h-fit' : 'h-0'">
          <router-link
            to="/Finance_Dashboard/Donation_Create"
            class="flex items-center gap-2 group hover:text-[#2e318a] duration-150"
            ><p
              class="h-[2px] w-3 bg-black group-hover:w-5 group-hover:bg-[#2e318a] duration-150"
            ></p>
            Create Donation Event / Purpose of donation</router-link
          >

          <router-link
            to="/Finance_Dashboard/Donation_Broadcast"
            class="flex items-center gap-2 group hover:text-[#2e318a] duration-150"
            ><p
              class="h-[2px] w-3 bg-black group-hover:w-5 group-hover:bg-[#2e318a] duration-150"
            ></p>
          ...
          <router-link
            to="/Finance_Dashboard/Donation_List"
            class="flex items-center gap-2 group hover:text-[#2e318a] duration-150"
            ><p
              class="h-[2px] w-3 bg-black group-hover:w-5 group-hover:bg-[#2e318a] duration-150"
            ></p>
            Donation Event / Purpose List</router-link
          >

          <router-link
            to="/Finance_Dashboard/Donation_Status"
            class="flex items-center gap-2 group hover:text-[#2e318a] duration-150"
            ><p
              class="h-[2px] w-3 bg-black group-hover:w-5 group-hover:bg-[#2e318a] duration-150"
            ></p>
      ...
      <div>
        ...
        <ul class="pl-8 flex flex-col gap-1 overflow-hidden" :class="drop == 3 ? 'h-fit' : 'h-0'">
          <router-link
            to="/Finance_Dashboard/Fund_Appllied_List"
            class="flex items-center gap-2 group hover:text-[#2e318a] duration-150"
            ><p
              class="h-[2px] w-3 bg-black group-hover:w-5 group-hover:bg-[#2e318a] duration-150"
            ></p>
            Applied Fund Event</router-link
          >
          <router-link
            to="/Finance_Dashboard/Fund_Create"
            class="flex items-center gap-2 group hover:text-[#2e318a] duration-150"
            ><p
              class="h-[2px] w-3 bg-black group-hover:w-5 group-hover:bg-[#2e318a] duration-150"
            ></p>
            Create Fund Event / Purpose of Fund</router-link
          >

          <router-link
            to="/Finance_Dashboard/Fund_Broadcast"
            class="flex items-center gap-2 group hover:text-[#2e318a] duration-150"
            ><p
              class="h-[2px] w-3 bg-black group-hover:w-5 group-hover:bg-[#2e318a] duration-150"
            ></p>
            Broadcast Fund Event
          </router-link>

          <router-link
            to="/Finance_Dashboard/Fund_List"
            class="flex items-center gap-2 group hover:text-[#2e318a] duration-150"
            ><p
              class="h-[2px] w-3 bg-black group-hover:w-5 group-hover:bg-[#2e318a] duration-150"
            ></p>
            Fund Event / Purpose List</router-link
          >

          <router-link
            to="/Finance_Dashboard/Fund_Status"
            class="flex items-center gap-2 group hover:text-[#2e318a] duration-150"
            ><p
              class="h-[2px] w-3 bg-black group-hover:w-5 group-hover:bg-[#2e318a] duration-150"
            ></p>
