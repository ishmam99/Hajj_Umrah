    ...
    <div class="bg-slate-50">
      <div class="pt-[80px] flex justify-between">
        ...
        <div class="px-5 bg-slate-50 py-5 w-3/4">
          <p class="text-2xl font-bold py-3 border-b">Deposits</p>
          <div class="container mx-auto p-8">
            ...
            <div v-if="expenses.length === 0" class="text-gray-500">No deposits yet.</div>
            <ul v-else>
              <li
            ...
            <div v-if="editingIndex !== null" class="mt-8 border-t pt-4">
              <h2 class="text-2xl font-semibold mb-4">Edit Deposit</h2>
