    ...
    <div class="px-4 bg-white py-5">
      ...
      <div>
        <div class="flex justify-between items-center pb-2">
          <p class="text-2xl text-yellow-600 font-bold">Project Expense Create</p>
          <button v-if="expenseCreate == false" @click="expenseCreate = true" class="w-[150px] py-2 rounded-md shadow-md bg-cyan-600 text-white text-sm">Create</button>
          <button v-if="expenseCreate == true" @click="expenseCreate = false" class="w-[150px] py-2 rounded-md shadow-md bg-red-600 text-white text-sm">Cancle</button>
        </div>
        <hr />
        <div
        ...
        >
          <form @submit.prevent="projectExpenseCreate()" class="w-full">
            <table class="table-auto w-full">
              <thead>
                <tr class="bg-white">
                  <!-- <th class="p-2 text-center w-[12%]">ID</th> -->
                  <th class="p-2 text-center w-1/5">Date</th>
                  <th class="p-2 text-center w-1/5">Peoject Name</th>
              ...
              <tbody>
                <tr class="">
                  ...
                  <td class="py-4 px-2 text-center text-sm w-1/5">
                    <input v-model="projectExpense.date" type="date" class="w-full p-2" />
                  </td>
                  <td class="py-4 px-2 text-center w-1/5">
                    <input v-model="projectExpense.project_name" type="text" class="w-full p-2" />
                  </td>
                  <td class="py-4 px-2 text-center w-1/5">
                    <input v-model="projectExpense.expense_type" type="text" class="w-full p-2" />
                  </td>
                  <td class="py-4 px-2 text-center w-1/5">
                    <input v-model="projectExpense.amount" type="text" class="w-full p-2" />
                  </td>
      ...
      <div v-if="expenseUpdate == true">
        <div class="flex justify-between items-center pb-2 pt-5">
          <p class="text-2xl text-yellow-600 font-bold">Project Expense Update</p>
      ...
      <div v-if="expenseUpdate == false">
        <div class="flex justify-between items-center pt-4 pb-2">
          <p class="text-2xl text-yellow-600 font-bold">Project Expense List</p>
          <input
            type="date"
          ...
          <table class="table-auto w-full">
            <thead>
              <tr class="bg-white">
                ...
                <th class="">Date</th>
                <th class="p-2 text-center w-1/6">Project Name</th>
            ...
            <tbody>
              <tr class="">
                ...
                <td class="py-4 p-2 text-center w-1/6">Winter Clothes Distribute</td>
                <td class="py-4 p-2 text-center w-1/6">Clothes</td>
                <td class="py-4 p-2 text-center w-1/6">$ 2500</td>
              ...
              <tr class="bg-white">
                ...
                <td class="py-4 p-2 text-center text-sm w-1/6">12/12/2023</td>
                <td class="py-4 p-2 text-center w-1/6">Winter Clothes Distribute</td>
                <td class="py-4 p-2 text-center w-1/6">Transport</td>
...
const projectExpenseCreate = async () => {
  try {
    const data = await api().post('project-expense-store', {
      method: 'post',
      body: projectExpense
    })
    console.log(data)
    toast({
      title: 'Project Expense Created '
    })
  } catch (error) {
    console.log(error)
  }
