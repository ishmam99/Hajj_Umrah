<template>
  <div class="px-5 bg-slate-50 py-5 w-[calc(100vw-255px)]">
          ...
          <div class="flex justify-between gap-5">
            ...
            <div class="w-1/3 flex flex-col gap-5">
              <div class="">
                ...
                >
                  <input type="text" placeholder="Enter Amount" class="h-full w-full absolute top-0 rounded-2xl bg-white px-4 py-2 text-sm text-gray-500 text-center"/>
                </div>
              </div>
              <div class="">
