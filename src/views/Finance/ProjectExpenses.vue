    ...
    <div class="bg-slate-50">
      <div class="pt-[80px] flex justify-between">
        ...
        <div class="px-5 bg-slate-50 py-5 w-3/4">
          <p class="text-2xl font-bold py-3 border-b">Project Expenses</p>
...
const expenses = ref([
  {
    id: 1,
    operationName: 'Youth Development Project',
    description:
      'Organize activities, workshops, and educational programs to support the development of Muslim youth within the community',
    amount: 500,
    date: new Date()
  },
  {
    id: 2,
    operationName: 'Health and Wellness Initiatives Project',
    description:
      'Organize activities, workshops, and educational programs to support the development of Muslim youth within the community',
    amount: 400,
    date: new Date()
