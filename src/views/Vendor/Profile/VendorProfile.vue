<template>
   <div class="px-[5%] bg-slate-50 py-5 w-4/5 flex flex-col items-center">
        ...
        <div class="bg-slate-100 shadow-md rounded-md p-5 mt-5 w-full border border-slate-200">
            <div class=" gap-3 items-center pt-2">
                ...
                <p class="text-xl font-semibold pb-2">{{store?.user?.vendor.address}}, {{store?.user?.vendor.country}}</p>
            </div>
