<template>
  ...
  >
    <div class="bg-[#135D66] p-5 h-full flex flex-col gap-3 font-semibold text-lg text-white">
      ...
      <router-link to="/Youth_Dashboard/Proile" class="flex items-center gap-2 bg-white p-2 rounded-md hover:bg-gray-200 text-slate-800"
        ><svg
      ...
      <div class="accordion">
        <button @click.stop="toggleAccordion('projectManagement')" class="flex items-center w-full gap-2 text-slate-800 bg-white p-2 rounded-md hover:bg-gray-200">
  ...
  <path stroke-linecap="round" stroke-linejoin="round" d="M10.5 6h9.75M10.5 6a1.5 1.5 0 1 1-3 0m3 0a1.5 1.5 0 1 0-3 0M3.75 6H7.5m3 12h9.75m-9.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-3.75 0H7.5m9-6h3.75m-3.75 0a1.5 1.5 0 0 1-3 0m3 0a1.5 1.5 0 0 0-3 0m-9.75 0h9.75" />
      ...
      <div class="accordion">
        <button @click.stop="toggleAccordion('bidManagement')" class="flex items-center gap-2 text-slate-800 bg-white p-2 rounded-md w-full hover:bg-gray-200">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
  <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h3.75M9 15h3.75M9 18h3.75m3 .75H18a2.25 2.25 0 0 0 2.25-2.25V6.108c0-1.135-.845-2.098-1.976-2.192a48.424 48.424 0 0 0-1.123-.08m-5.801 0c-.065.21-.1.433-.1.664 0 .414.336.75.75.75h4.5a.75.75 0 0 0 .75-.75 2.25 2.25 0 0 0-.1-.664m-5.8 0A2.251 2.251 0 0 1 13.5 2.25H15c1.012 0 1.867.668 2.15 1.586m-5.8 0c-.376.023-.75.05-1.124.08C9.095 4.01 8.25 4.973 8.25 6.108V8.25m0 0H4.875c-.621 0-1.125.504-1.125 1.125v11.25c0 .621.504 1.125 1.125 1.125h9.75c.621 0 1.125-.504 1.125-1.125V9.375c0-.621-.504-1.125-1.125-1.125H8.25ZM6.75 12h.008v.008H6.75V12Zm0 3h.008v.008H6.75V15Zm0 3h.008v.008H6.75V18Z" />
        ...
        <div v-if="currentAccordions === 'bidManagement'" class="submenu mx-8">
          ...
          <router-link to="/Youth_Dashboard" class="flex items-center gap-2 hover:px-2">-
      ...
      <!-- <router-link to="/Youth_Dashboard/Youth_Program_Create" class="flex items-center gap-2"
        ...
        >
          ...
          ></path></svg>Create Program</router-link>
      ...
      <router-link to="/Youth_Dashboard/Program_List" class="flex items-center gap-2">
        ...
        >
          <path
            d="M9 1V3H15V1H17V3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H7V1H9ZM20 11H4V19H20V11ZM11 13V17H6V13H11ZM7 5H4V9H20V5H17V7H15V5H9V7H7V5Z"
          ></path></svg >Program List</router-link>
        ...
        >
          <path
            d="M9 1V3H15V1H17V3H21C21.5523 3 22 3.44772 22 4V20C22 20.5523 21.5523 21 21 21H3C2.44772 21 2 20.5523 2 20V4C2 3.44772 2.44772 3 3 3H7V1H9ZM20 11H4V19H20V11ZM11 13V17H6V13H11ZM7 5H4V9H20V5H17V7H15V5H9V7H7V5Z"
          ></path></svg>Program Broadcast</router-link>
      ...
      <router-link to="" class="flex items-center gap-2 bg-white text-slate-800 p-2 rounded-md"
        ><svg
          xmlns="http://www.w3.org/2000/svg"
          viewBox="0 0 24 24"
          width="24"
