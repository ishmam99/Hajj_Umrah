    ...
    <div class="px-1">
      <div class="flex">
        <div class="flex my-2 py-1 px-3 bg-gray-300 rounded-md w-1/2 justify-start gap-4 items-center">
          ...
          <select v-model="selectedYear" @change="filterPackages"
            class="select select-bordered px-4 py-2 w-full rounded border shadow">
        ...
        <div class="flex my-2 py-1 px-3 bg-gray-300 rounded-md w-1/2 justify-start gap-4 items-center">
          ...
          <select v-model="selectedCity" @change="filterPackages"
            class="select select-bordered px-4 py-2 rounded border shadow">
      ...
      <div class="overflow-x-auto">
        <table class="table w-full border-collapse border border-gray-300">
          ...
          <tbody>
            <tr v-if="allList.length > 0" v-for="(packageData, index) in allList" :key="packageData.id"
